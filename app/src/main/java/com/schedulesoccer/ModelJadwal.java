...
public class ModelJadwal {
    ...
    public String getStrHomeforward() {
        return strHomeforward;
    }

    public void setStrHomeforward(String strHomeforward) {
        this.strHomeforward = strHomeforward;
    }
    ...
    public String getStrAwayforward() {
        return strAwayforward;
    }

    public void setStrAwayforward(String strAwayforward) {
        this.strAwayforward = strAwayforward;
    }
